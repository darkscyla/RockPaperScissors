...
const getHumanChoice = () => {
    ...
    while (!options.includes(humanChoice) && humanChoice != null) { // Keep going until the human choses a valid value or cancels
...
const playGame = (number_of_rounds) => {
    ...
    for (let index = 0; index < number_of_rounds; ++index) {
        ...
        console.log(`The human chose: ${humanChoice} --- The overlord chose: ${computerChoice}`);
    ...
    console.log(`Human score: ${humanScore} --- Overlord score: ${computerScore}`);
    const message = (humanScore === computerScore) ? "The human is sentenced to life in prison!" :
        (humanScore > computerScore ? "The human is sentenced to death!" : "The overlord forgives the human this time!");
    console.log(message)
};
